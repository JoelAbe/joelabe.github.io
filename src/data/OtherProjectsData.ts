...
export default [
    ...
    <div class="paragraph">
        <div class="notice">You can play the game here: <a href="https://gamedeveloperskerala.itch.io/big-bubble-deep-trouble" target="_blank">gamedeveloperskerala.itch.io/big-bubble-deep-trouble</a></div>
    </div>
