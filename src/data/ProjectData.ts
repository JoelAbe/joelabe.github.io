export default class ProjectData {
    ...
    engine: string; // engine badge shown on the thumbnail, e.g. "Unity" or "Unreal Engine 5"

    constructor(id: string, name: string, iconUrl: string, html: string, accentColor = "#000000", isHigh = false, isWide = false, engine = ""){
        this.id = id;
        this.name = name;
